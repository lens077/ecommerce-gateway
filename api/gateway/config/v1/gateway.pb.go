...
const file_gateway_config_v1_gateway_proto_rawDesc = "" +
	"\n" +
	"\x1fgateway/config/v1/gateway.proto\x12\x11gateway.config.v1\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\"\xc0\x02\n" +
	"\aGateway\x12\x12\n" +
	...
	"\vmiddlewares\x18\x05 \x03(\v2\x1d.gateway.config.v1.MiddlewareR\vmiddlewares\x128\n" +
	"\x04envs\x18\x06 \x03(\v2$.gateway.config.v1.Gateway.EnvsEntryR\x04envs\x1a7\n" +
	"\tEnvsEntry\x12\x10\n" +
	...
	"\tendpoints\x18\x03 \x03(\v2\x1b.gateway.config.v1.EndpointR\tendpoints\"\x87\x04\n" +
	"\bEndpoint\x12\x12\n" +
	...
	"\rrouter_filter\x18\x04 \x01(\v2*.gateway.config.v1.Middleware.RouterFilterR\frouterFilter\x1a4\n" +
	"\x04Rule\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x18\n" +
	"\amethods\x18\x02 \x03(\tR\amethods\x1aH\n" +
	"\fRouterFilter\x128\n" +
	"\x05rules\x18\x01 \x03(\v2\".gateway.config.v1.Middleware.RuleR\x05rules\"\x8c\x01\n" +
	"\aBackend\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x1b\n" +
	"\x06weight\x18\x02 \x01(\x03H\x00R\x06weight\x88\x01\x01\x12A\n" +
	"\fhealth_check\x18\x03 \x01(\v2\x1e.gateway.config.v1.HealthCheckR\vhealthCheckB\t\n" +
	"\a_weight\"\r\n" +
	...
	"\x04GRPC\x10\x02B4Z2github.com/go-kratos/gateway/api/gateway/config/v1b\x06proto3"
